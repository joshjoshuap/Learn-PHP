@include('partials.header', ['title' => 'Admin Register'])
<header class='max-w-lg mx-auto'>
    <a href=''>
        <h1 class="text-4xl font-bold text-center">Admin Register</h1>
    </a>
</header>
<main class="bg-gray-600 max-w-lg mx-auto p-8 my-10 rounded-lg shadow">
    <section>
        ...
        <p class="text-gray-200 pt-4">Sign in to your account</p>
    </section>
    <section class="mt-10">
